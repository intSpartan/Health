...
import { redirect, Link, useRouter } from 'next/navigation'
    ...
    <header className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 " aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <SignedIn>
            <a href="/dashboard" className="text-lg font-semibold leading-6 text-gray-900">
              Dashboard
            </a>
          </SignedIn>
          <a href="#" className="text-lg font-semibold leading-6 text-gray-900">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end" onClick={handleLogin}>
          <LoginButton />
        </div>
      </nav>
